 ...
 */
namespace PrivateIT\modules\httpClient;
 ...
 *
 * @package PrivateIT\modules\httpClient
 */
class HttpClientModule extends Module
{
     ...
     */
    public $tablePrefix = 'http_client_';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['http-client/*'])) {
            Yii::$app->i18n->translations['http-client/*'] = [
    ...
    /**
     * @return null|Module|HttpClientModule
     */
